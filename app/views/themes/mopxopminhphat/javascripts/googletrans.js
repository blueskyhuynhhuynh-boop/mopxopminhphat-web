$(document).ready(function(){
  (function () {
    ...
    if (gt && gt.default_language != null) {
      console.log("✅ gtranslateSettings initialized:", gt);
    } else {
    ...
    if (url_structure == "none") {
      ...
      function load_tlib() {
        if (!window.gt_translate_script) {
          ...
          // ✅ Log nếu load thành công
          gt_translate_script.onload = function () {
            console.log("✅ gt_translate_script loaded successfully");
          };

          // ❌ Log nếu load thất bại
          gt_translate_script.onerror = function () {
            console.error(
              "❌ Failed to load gt_translate_script from Google Translate"
            );
          };
      ...
      window.googleTranslateElementInit2 = function () {
        console.log("✅ googleTranslateElementInit2 initialized");
